    ...
    <div class="card-body login-card-body">
       ...
       <form method="POST" action="{{ route('login') }}">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button style="background-color: #F2A349; color:cornsilk;" type="submit" class="btn btn-block">Entrar</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
      ...
      <p class="mb-0">
        <a href="\register" class="text-center">Registrar novo membro</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
